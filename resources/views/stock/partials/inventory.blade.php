<div class="modal-header">
    ...
    <h4 class="modal-title text-black">INVENTAIRE : <span class="uppercase"><u>{{$movement->reference}}</u></span>
        <span class="capitalize pull-right">{{\Jenssegers\Date\Date::parse($movement->created_at)->format('j M Y')}}</span></h4>
</div>
<div class="modal-body" id="print">
    <p>Liste des pieces Ajustées le {{$movement->created_at->format('d/m/Y')}}</p>

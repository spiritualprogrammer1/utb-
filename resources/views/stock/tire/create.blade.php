...
@section('content')
                    ...
                    <div class="panel-body panel-danger" style="height:680px;position: relative;overflow: scroll">
                        <div class="row">
                            <div class="has-success form-group-sm col-md-8">
                                ...
                                <input type="text" name="reference" id="reference" min="3"
                                       ...
                                       placeholder="Reference du pneu" required>
                            </div>
                        </div>
                        <div class="row m-t-sm m-b-sm">
                            <div class="has-success form-group-sm col-md-8">
                                <label class="control-label">DOT</label>
                                <input type="text" name="dot" id="dot" min="2"
                                       class="form-control input-sm text-danger-dk uppercase"
                                       placeholder="DOT HP UT 6TJU 1909" required>
                            </div>
                        </div>
                        ...
                        <div class="row m-t-sm m-b-sm">
                            ...
                            <div class="has-success form-group-sm col-md-6">
                                ...
                                <input type="text" name="libelle" id="libelle" min="2"
                                       class="form-control input-sm text-danger-dk uppercase"
                                       placeholder="Libelle du pneu" required>
                            </div>

                            <div class="form-group-sm col-md-6">
                                <label class="control-label">Etat du pneu</label>
                        ...
                        <div class="row m-t-sm m-b-sm">
                            <div class="form-group-sm  col-sm-12">
                                <label class="control-label">Sens du pneu </label>
                                <select class="chosen-select input-sm form-control"
                                        data-placeholder="CHOISISEZ UN TYPE..." id="sens_tire" name="sens_tire">
                                    <option></option>
                                    <option value="pneu arriere gauche">pneu arriere gauche</option>
                                    <option value="pneu devant gauche">pneu devant gauche</option>
                                    <option value="pneu arrière droit">pneu arrière droit</option>
                                    <option value="pneu avant droit ">pneu avant droit</option>
                                </select>
                            </div>
                        </div>
                        <div class="row m-t-sm m-b-sm">
                            <div class="form-group-sm  col-sm-12">
                                <label>Type du pneu</label>
                                <select class="chosen-select input-sm form-control"
                                        data-placeholder="CHOISISEZ UN TYPE..." id="type_pneu" name="typtire_id">
                                    <option></option>

                                    @foreach($typetires as $typetire)
                                        <option value="{{$typetire->id}}"
                                                class="uppercase">{{$typetire->name}}</option>
                                        @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row m-t-sm m-b-sm">
                            ...
                            <div class="form-group-sm col-sm-6">
                                <label class="control-label">Modele pneu</label>
                                <select class="chosen-select input-sm form-control"
                        ...
                        <div class="row">
                            <div class="has-info form-group-sm col-sm-4 m-t-sm m-b-sm">
                                <label class="control-label">Kilométrage</label>
                                <input type="text" name="mileage" id="mileage"  class="form-control input_numeric input-sm text-danger-dk uppercase"
                                       placeholder="" required >

                            </div>
                            <div class="has-danger form-group-sm col-sm-8 m-t-sm m-b-sm">
                                <label class="control-label">Vitesse maximale en km/h</label>
                            ...
                            <div class="has-danger form-group-sm col-sm-6 m-t-sm m-b-sm">
                                ...
                                <input type="text" name="weight" id="weight" class="form-control input-sm text-danger-dk uppercase"
                                       placeholder="en kg" required >

                            </div>
                            <div class="has-danger form-group-sm col-sm-6 m-t-sm m-b-sm">
                                <label class="control-label">Largeur </label>
                                <input type="text" name="width" id="width" min="3" maxlength="9"
                                       class="form-control input-sm input_numeric text-danger" placeholder="0"
                                       required>
                            ...
                            <div class="has-danger form-group-sm col-sm-9 m-t-sm m-b-sm">
                                <label class="control-label">Charge en kg / pneu </label>
                                <input type="text" name="charge" id="charge"  class="form-control input-sm text-danger-dk uppercase"
                                       placeholder="le nbre de charge" required >

                            </div>

                            <div class="has-danger form-group-sm col-sm-6 m-t-sm m-b-sm">
                                <label class="control-label">Hauteur </label>
                                <input type="text" name="hauteur" id="hauteur" min="3" maxlength="9"
                                       class="form-control input-sm input_numeric text-danger" placeholder="0"
                                       required>
                            ...
                            <div class="has-danger form-group-sm col-sm-6 m-t-sm m-b-sm">
                                ...
                                <input type="text" name="diametre" id="diametre" min="3" maxlength="9"
                                       class="form-control input-sm input_numeric text-danger" placeholder="0"
                                       required>
    ...
    <input type="hidden" value="2" name="stock_type">
                        ...
                        <div class="">
                            ...
                            <a href="#" class="btn btn-sm btn-icon btn-info pull-right btn_reset none"
                               onclick="reset_btn($('#submit'), $('#delivery'),$('#order'),$('#supplier'),$('#quantity'), $('#brand'), $('#model'), $('#category'), $('#subcategory'),
                           $('#ray'), $('#shelf'), $('#block'),$('#vitesse'),$('#mileage'),
                           $('#type_pneu'),$('#reference'),$('#libelle'),$('#weight'),$('#width'),$('#charge'),$('#hauteur'),$('#diametre'),$('#dot'),$('#sens_tire'));">
                ...
                <header class="header bg-white b-b clearfix">
                    <div class="row m-t-sm">
                        <div class="col-sm-6 m-b-xs">
                            ...
                            <h4>  <img src='{{asset('assets/logo/PNEU1.jpg')}}' width="40" /> LISTE DES PNEUS </h4>
                        </div>
...
@section('scripts')
    ...
    <script>
            ...
            $form.on('submit', function (e) {
               ...
               // var formData = $(this).serialize();
                ...
                if (state == 'edit') {
                    ...
                    msg = "le pneu a été mis à jour";
                }

                status = "success";
                var msg = "le pneu a bien été enregistrer";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        reset_btn($('#submit'), $('#delivery'),$('#order'),$('#supplier'),$('#quantity'), $('#brand'), $('#model'), $('#category'), $('#subcategory'),
                            $('#type'),$('#ray'), $('#shelf'), $('#block'),$('#vitesse'),$('#mileage'),
                            $('#type_pneu'),$('#reference'),$('#libelle'),$('#weight'),$('#width'),$('#charge'),$('#hauteur'),$('#diametre'),$('#dot'),$('#sens_tire'))
                        ...
                        reset_btn($this, $delivery, $order, $supplier, $quantity, $brand, $model, $category, $subcategory, $type,$ray,$shelf,$block,$type_pneu,
                           $shelf,$reference,$libelle,$vitesse,$weight,$width,$charge,$hauteur,$diametre,$dot,$sens_tire);
        ...
        reset_btn($('#submit'), $('#delivery'),$('#order'),$('#supplier'),$('#quantity'), $('#brand'), $('#model'), $('#category'), $('#subcategory'),
            $('#type'),$('#ray'), $('#shelf'), $('#block'),$('#vitesse'),$('#mileage'),
            $('#type_pneu'),$('#reference'),$('#libelle'),$('#weight'),$('#width'),$('#charge'),$('#hauteur'),$('#diametre'),$('#dot'))




        function reset_btn(obj,delivery,order,supplier,quantity, brand, model, category, subcategory, type,ray,shelf,block,vitesse,mileage,type_pneu,reference,libelle,weight,width,charge,hauteur,diametre,dot,sens_tire) {
        ...
        function type_pneu(id)
        {
            var type = "change";
            $.get('../stock/type_pneu/' + id + '/' + type, function (data) {
                $('#type_pneu').empty();
                $.each(data, function (index, contractObj) {
                    $('#type_pneu').append('<option value="' + contractObj.id + '">' + contractObj.name + '</option>');
                    $('#type_pneu').trigger("chosen:updated");

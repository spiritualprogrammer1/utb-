<header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
    <div class="navbar-header aside-md dk">
        ...
        <?php $entreprise=App\Entreprise::all(); ?>
        <a href="{{url('/')}}" class="navbar-brand">
            @if(isset($entreprise) and !empty($entreprise))
            @if($entreprise[0]->picture)
            <img src="{{asset('picture_employe/'.$entreprise[0]->picture)}}" class="m-r-sm" alt="scale">
    ...
    <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
        ...
        <li class="dropdown">
            ...
            <span class="thumb-sm avatar pull-left">
              ...
              <!--<input type="hidden" id="valeurposte" value=" //Auth::user()->employee->post->name">-->
                <b class="caret"></b>
            </a>

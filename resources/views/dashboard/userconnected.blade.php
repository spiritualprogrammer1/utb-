<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Liste des utilisateurs connectés
        ...
        <div class="modal-body ">
            <div class="panel-body clearfix">
                <div class="row">
                    <table class="table table-responsive table-stripped" id="userTable">
                        <thead>
                        <tr>
                            <th>#</th>
                            <th>NOM</th>
                        ...
                        <tbody>
                        @foreach($userconnect as $key=> $userconnec)
                            <tr id="contractor">
                                <td>{{$key+1}}</td>
                                <td class="alert alert-success">
                                    {{strtoupper($userconnec->first_name)}}
                                </td>
                                <td style="text-transform: capitalize">{{strtoupper($userconnec->last_name)}}</td>
                                <td>{{strtoupper($userconnec->email)}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>

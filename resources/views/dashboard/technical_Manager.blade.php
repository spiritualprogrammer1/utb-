@section('title') Chef Technique @endsection
            ...
            <section class="vbox">
                <section class="scrollable padder">
                    <section class="row m-b-md">
                        <div class="col-sm-6">
                            <h3 class="m-b-xs text-black">Tableau de bord : &nbsp; <small class="text-info" ><strong>Chef des  techniciens</strong></small></h3>
                            ...
                            <div class="panel b-a">
                                <div class="row m-n">
                                    ...
                                    <div class="col-md-6 b-b b-r">
                                        <a href="#" title="Demande de  pièce en attente"
    ...
    <script type="text/javascript">
        ...
        $('#valider').on('mouseup', function (e) {
            ...
            $.get("{{url('technicalManagerdashboard')}}", {datedebu: datedebu, datefin: datefin,site:site}, function (data) {
                ...
                $('.lien_pannekm').text(data.lien_pannekm);

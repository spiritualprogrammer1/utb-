<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Liste des  véhicules en attente de pièces
                    ...
                    <table class="table table-responsive table-stripped" id="vehicleTable">
                        ...
                        @foreach($data as $key=> $data)
                            <tr id="contractor">
                                ...
                                <td>{{strtoupper($data->matriculation)}}</td>
                                <td style="text-transform: capitalize">{{$data->model." ".$data->brandname}}</td>

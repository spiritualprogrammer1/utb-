<header class="panel-heading text-right bg-light">
    <ul class="nav nav-tabs nav-justified  uppercase">
        <li><a href="#visit-description" data-toggle="tab">
                <i class="i i-users2 text-muted"></i> Detail de la visite</a>
        </li>
        <li><a href="#technicians" data-toggle="tab">
                <i class="i i-users2 text-muted"></i> Techniciens</a>
        </li>
        <li><a href="#visit-pieces" data-toggle="tab">
                <i class="i i-users2 text-muted"></i> Liste des piéces attribuées</a>
        </li>

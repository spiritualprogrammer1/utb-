<header class="panel-heading text-right bg-light">
    <ul class="nav nav-tabs nav-justified  uppercase">
        <li class="dropdown @if($visit->state == 4) @else active @endif">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                        class="fa fa-comments text-muted"></i> Details <b class="caret"></b></a>
            <ul class="dropdown-menu text-left">
                <li><a href="#visit-description" data-toggle="tab">
                        <i class="i i-list"></i> Detail des révisions</a>
                </li>
                <li><a href="#visit-new" data-toggle="tab">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu text-left">
                <li><a href="#visit-pieces" data-toggle="tab"><i class="i i-stack"></i> Liste des piéces attribuées</a>
                </li>
                <li><a href="#visit-piece" data-toggle="tab"><i class="i i-stack2"></i> Demande des pieces</a></li>
            </ul>
        </li>
        @if($visit->state == 4)
...
<div class="panel-body">
    <div class="tab-content">
        <div class="tab-pane fade @if($visit->state == 4) @else active in @endif" id="visit-description">
            <div class="panel-group m-b" id="accordionDescription">
                <?php $count = $visit->diagnostic->service_description->count() ?>
                @foreach($visit->diagnostic->service_description->sortByDesc('created_at') as $key=>$description)
        ...
        <div class="tab-pane fade" id="visit-new">
            <a href="#"
        ...
        <div class="tab-pane fade" id="visit-pieces">
            <table class="table table-striped m-b-none">
                ...
                <tbody>
                <?php $count = '' ?>
                @forelse($visit->diagnostic->demand as $demand)
                    @if($visit->diagnostic->demand )
                        @if($demand->state == '0')
                            <?php $count = '1' ?>
                        @endif
                    @endif
                ...
                @if($count)
                    <span class="text-center" style="margin-left: 40%;">
                        <span class="badge bg-danger badge-sm">{{$visit->diagnostic->demand->where('state','0')->count()}}</span>
        ...
        <div class="tab-pane fade" id="visit-piece">
            <a href="#"
               class="btn btn-sm btn-info pull-right uppercase"
               id="piece_add">
                <i class="fa fa-plus-circle"></i>
            ...
            <div class="row">
                <div class="col-md-4">
                    <ul class="list-group alt">
                        @foreach($visit->diagnostic->service_employee as $key=>$technician)
        ...
        <div class="tab-pane fade @if($visit->state == 4) active in @endif" id="afterworks">
            <div class="panel-group m-b" id="accordionRemark">
                <?php $count = $visit->diagnostic->work->where('state', '4')->count() ?>
                @foreach($visit->diagnostic->work->where('state','4')->sortByDesc('created_at') as $key=>$item)

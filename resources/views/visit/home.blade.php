@section('title') Visit Technique du Car @endsection
        ...
        <aside>
            <section class="vbox">
                <header class="header bg-light lt b-b  b-b clearfix">
                    <p class="h4 font-thin pull-left m-r m-b-sm"><i class="i i-params"></i> VISIT TECHNIQUE</p>
                    <a href="#subNav" data-toggle="class:show" class="btn btn-sm btn-info btn-icon btn-rounded
                    @if($active == '0') disabled @endif" id="visitAdd">
                    ...
                    <div class="btn-group pull-right" data-toggle="buttons">
                        <a href="#" class="btn btn-sm btn-bg btn-default btn-rounded"
                           onclick="$('#visitTable').tableExport({type:'xlsx',escape:'false'});">
                            <img src="{{asset('assets/images/icons/xls.png')}}" width="20"> Excel
                        </a>
                        <a href="#" class="btn btn-sm btn-bg btn-default"
                           onclick="$('#visitTable').tableExport({type:'pdf',escape:'false'});">
                            <img src="{{asset('assets/images/icons/pdf.png')}}" width="20"> PDF
                        </a>
                        <a href="#" class="btn btn-sm btn-bg btn-default btn-rounded"
                           onclick="$('#visitTable').tableExport({type:'csv',escape:'false'});">
                ...
                <section class="scrollable wrapper bg-light dker w-f">
                    <section class="panel panel-default">
                        <div class="table-responsive">
                            <table class="table table-striped m-b-none capitalize" id="visitTable">
                                <thead>
                                <tr>
                                    <th></th>
            ...
            $form_create.on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var row = '<tr id="visit' + data.id + '" class="alert alert-info text-danger-dk font-bold">' +
                            '<td>' + data.count + '</td>' +
                            ...
                            '<td>' + data.bus + '</td>' +
                            '<td>' + data.date + '</td>' +
                            '<td><a href="#" id="' + data.id + '" onclick="visit(this)" data-car="'+data.bus+'" data-matriculation="'+data.matriculation+'" data-ot="'+data.reference+'">' +
                            '<i class="fa fa-pencil"></i></a></td>' +
                            '<td><span class="badge bg-success text-lowercase">en cours</span></td><tr>';
                        $visit_row.before(row);
